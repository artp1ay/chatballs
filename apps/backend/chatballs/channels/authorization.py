...
def require_channel_manage(
    context: TenantContext, *, channel: object | None = None
) -> None:
    if channel is not None and getattr(channel, "organization_id", None) != context.organization_id:
