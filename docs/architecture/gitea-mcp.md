...
- Подключение установлено на компанию, но оставлено в состоянии `draft` и
  выключено.
...
- PAT пока не добавлен. До добавления secret агентские tool calls не активируются.

## Активация

1. Создать в Gitea PAT с минимальными необходимыми правами. Для выбранного
   read/write режима обычно нужны права на repository, issues, pull requests и
   wiki; отдельно выдавать Actions/административные права без необходимости не
   следует.
2. Сохранить PAT только в зашифрованном Paperclip secret с именем
